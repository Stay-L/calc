...
HWND hWnd;
HWND hSqr, hRev, hDiv, hMult, hSub, hAdd, hEqual, hBrL;
HWND hC;
...
void MainWndAddWidgets(HWND hWnd) {
    ...
    hBrL = hButtons[18] = CreateWindowA("BUTTON", "(", WS_CHILD | WS_VISIBLE | BS_DEFPUSHBUTTON,
